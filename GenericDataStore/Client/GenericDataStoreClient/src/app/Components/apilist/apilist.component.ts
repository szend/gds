...
import { ApicreateComponent } from '../apicreate/apicreate.component';
...
@Component({
  ...
  styleUrl: './apilist.component.css'
})
export class ApilistComponent implements OnInit {
  ...
  CreateNew() {
    this.ref = this.dialogService.open(ApicreateComponent,  { data: {dataRec: null, createmode : true}, header: 'Create new database connection', resizable: true});
  ...
  Edit(row : any){
    this.ref = this.dialogService.open(ApicreateComponent,  { data: {dataRec: row, createmode : false}, header: 'Edit database connection', resizable: true});
    this.ref.onClose.subscribe(x => {
      this.Refresh();
    });
  }
