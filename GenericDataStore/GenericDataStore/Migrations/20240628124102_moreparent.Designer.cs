...
namespace GenericDataStore.Migrations
{
    ...
    [Migration("20240628124102_moreparent")]
    partial class moreparent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ObjectTypeObjectType", b =>
                {
                    b.Property<Guid>("ChildObjectTypesObjectTypeId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ParentObjectTypesObjectTypeId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ChildObjectTypesObjectTypeId", "ParentObjectTypesObjectTypeId");

                    b.HasIndex("ParentObjectTypesObjectTypeId");

                    b.ToTable("ObjectTypeObjectType");
                });
            ...
            modelBuilder.Entity("ObjectTypeObjectType", b =>
                {
                    b.HasOne("GenericDataStore.Models.ObjectType", null)
                        .WithMany()
                        .HasForeignKey("ChildObjectTypesObjectTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GenericDataStore.Models.ObjectType", null)
                        .WithMany()
                        .HasForeignKey("ParentObjectTypesObjectTypeId")
